...
describe User do
  ...
  before do
    @user = User.new(first_name: "Donald",
    last_name: "Draper",
    username: "don",
  ...
  describe "when password" do
    ...
    describe "is too long" do
      before { @user.password = @user.password_confirmation = "a" * 66 }
      it { should be_invalid }
    end
  end
